...
Reference: ICAO Annex 2, Chapter 5 — minimum levels for IFR flight`,
  ...
  },
  {
    ...
    ans: 2,
    exp: `Cabin crew are calculated on SEATS INSTALLED, never on the passengers actually carried — so the load of 136 is a deliberate distractor. An aircraft is crewed for the seats it has. Rule 38B(1) of the Aircraft Rules, 1937 sets the minimum: an aeroplane with a seating capacity of not less than 10 and not more than 50 needs one cabin crew; and an aircraft with a seating capacity of more than 50 needs two cabin crew, plus one more for each unit (or part of a unit) of 50 passenger seats above a seating capacity of 99. Note the threshold is 99, not 100 — that single seat is what most people get wrong. For 250 seats: 250 − 99 = 151, which is three full units of 50 plus a part unit, so it counts as 4, giving 2 + 4 = 6. Working the same way: 100–149 seats needs 3, 150–199 needs 4, 200–249 needs 5, and 250–299 needs 6.`,
  },
  {
    subjectIds: ["air-regulations", "atpl-air-regulations"],
    chapterId: "ar-5",
