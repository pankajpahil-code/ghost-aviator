...
export const CPL_SUBJECTS: Subject[] = [
  ...
  // ── PAPER 2 ── Appendix B ────────────────────────────────────────────────
  {
    ...
    chapters: [
      {
        id: "met-1", number: 1, title: "The Atmosphere",
        description: "Composition, extent, vertical divisions. Temperature: vertical distribution, heat transfer (solar/terrestrial radiation, conduction, convection, advection, turbulence), lapse rate, stability, inversions, diurnal variation. Atmospheric pressure: isobars, pressure variation with height, QFF, surface/upper-air highs and lows. Atmospheric density, ISA.",
        duration: "3 hrs", questionCount: 80, content: makeContent(),
      },
      {
        id: "met-2", number: 2, title: "Altimetry",
        description: "Pressure altitude vs true altitude, height/altitude/flight level, altimeter settings (QNH, QFE, 1013.25 hPa), effect of accelerated airflow due to topography.",
        duration: "2 hrs", questionCount: 60, content: makeContent(),
      },
      {
        id: "met-3", number: 3, title: "Wind",
        description: "Definition and measurement, primary cause of wind (pressure gradient, Coriolis force, gradient wind), relationship between isobars and wind, general global circulation, turbulence types (origin and location), variation of wind with height (friction layer), local winds (anabatic, katabatic, land/sea breezes, venturi effects), standing waves.",
        duration: "3 hrs", questionCount: 80, content: makeContent(),
      },
      {
        id: "met-4", number: 4, title: "Humidity, Clouds & Fog",
        description: "Water vapour, temperature/dewpoint, mixing ratio, relative humidity. Cloud formation, types and classification, influence of inversions on cloud development. Fog types: radiation, advection, steaming, frontal, orographic fog.",
        duration: "3 hrs", questionCount: 80, content: makeContent(),
      },
      {
        id: "met-5", number: 5, title: "Precipitation",
        description: "Development of precipitation, types of precipitation, relationship of precipitation types with cloud types.",
        duration: "2 hrs", questionCount: 55, content: makeContent(),
      },
      {
        id: "met-6", number: 6, title: "Airmasses & Fronts",
        description: "Classification of airmasses, factors affecting properties, modifications, areas of origin. Fronts: warm front (clouds, weather), cold front, warm sector, weather behind cold front, occlusions, stationary front, movement of fronts and pressure systems, life cycle.",
        duration: "3 hrs", questionCount: 80, content: makeContent(),
      },
      {
        id: "met-7", number: 7, title: "Pressure Systems",
        description: "Principal pressure areas. Anticyclones: types, properties, cold and warm anticyclones, ridges, wedges, subsidence. Non-frontal depressions: thermal, orographic, secondary, cold air pools, troughs. Tropical revolving storms.",
        duration: "3 hrs", questionCount: 75, content: makeContent(),
      },
      {
        id: "met-8", number: 8, title: "Climatology — Indian Weather",
        description: "Typical mid-latitude weather (westerly waves, high pressure, uniform pressure). Local seasonal weather: SE & NE Monsoon, Pre-Monsoon, Northwesters, Kalbaisakhi, Western Disturbance.",
        duration: "2 hrs", questionCount: 60, content: makeContent(),
      },
      {
        id: "met-9", number: 9, title: "Flight Hazards",
        description: "Icing (conditions, topographical effects), turbulence (effects, avoidance), windshear (definition, conditions, effects on flight), thunderstorms (structure, squall lines, down-bursts, lightning), inversions (influence on performance), mountainous area hazards (mountain waves, CAT, icing), visibility reducing phenomena (mist, smoke, dust, blowing snow).",
        duration: "4 hrs", questionCount: 95, content: makeContent(),
      },
      {
        id: "met-10", number: 10, title: "Meteorological Information",
        description: "Surface observations (wind, visibility, RVR, clouds, weather, temperature, pressure). Aircraft reports, PIREPs, data link. Weather charts: significant weather, surface, upper air, symbols. Aviation codes: METAR, TAF, SPECI, SIGMET, SNOWTAM, runway report. Broadcasts: VOLMET, ATIS, HFVOLMET, ACARS. Pre-flight met documents and briefing.",
        duration: "4 hrs", questionCount: 95, content: makeContent(),
      },
    ],
  },
