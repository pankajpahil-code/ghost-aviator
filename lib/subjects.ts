...
// RTR(A) book chapters: notes + extracted question bank + chapter quiz.
...
export const CPL_SUBJECTS: Subject[] = [
  ...
  // ── PAPER 4 ── Appendix D ────────────────────────────────────────────────
  {
    ...
    chapters: [
      {
        id: "tg-1", number: 1, title: "The Atmosphere and Its Properties",
        description: "Principles of Flight — The Atmosphere and Its Properties. Chapter notes from Technical General for Aviators by Capt. Pankaj Pahil.",
        duration: "1 hr", questionCount: 5, content: makeContent(true),
      },
      {
        id: "tg-2", number: 2, title: "Fundamental Aerodynamic Principles",
        description: "Principles of Flight — Fundamental Aerodynamic Principles. Chapter notes from Technical General for Aviators by Capt. Pankaj Pahil.",
        duration: "1 hr", questionCount: 5, content: makeContent(true),
      },
      {
        id: "tg-3", number: 3, title: "The Aerofoil and Subsonic Airflow",
        description: "Principles of Flight — The Aerofoil and Subsonic Airflow. Chapter notes from Technical General for Aviators by Capt. Pankaj Pahil.",
        duration: "1 hr", questionCount: 5, content: makeContent(true),
      },
      {
        id: "tg-4", number: 4, title: "Lift, Drag, and the Angle of Attack",
        description: "Principles of Flight — Lift, Drag, and the Angle of Attack. Chapter notes from Technical General for Aviators by Capt. Pankaj Pahil.",
        duration: "1 hr", questionCount: 5, content: makeContent(true),
      },
      {
        id: "tg-5", number: 5, title: "Three-Dimensional Airflow and Wing Design",
        description: "Principles of Flight — Three-Dimensional Airflow and Wing Design. Chapter notes from Technical General for Aviators by Capt. Pankaj Pahil.",
        duration: "1 hr", questionCount: 5, content: makeContent(true),
      },
      {
        id: "tg-6", number: 6, title: "A Deeper Dive into Drag",
        description: "Principles of Flight — A Deeper Dive into Drag. Chapter notes from Technical General for Aviators by Capt. Pankaj Pahil.",
        duration: "1 hr", questionCount: 5, content: makeContent(true),
      },
      {
        id: "tg-7", number: 7, title: "Stalling, Spinning, and Recovery",
        description: "Principles of Flight — Stalling, Spinning, and Recovery. Chapter notes from Technical General for Aviators by Capt. Pankaj Pahil.",
        duration: "1 hr", questionCount: 6, content: makeContent(true),
      },
      {
        id: "tg-8", number: 8, title: "High-Lift Devices",
        description: "Principles of Flight — High-Lift Devices. Chapter notes from Technical General for Aviators by Capt. Pankaj Pahil.",
        duration: "1 hr", questionCount: 5, content: makeContent(true),
      },
      {
        id: "tg-9", number: 9, title: "Aircraft Stability",
        description: "Principles of Flight — Aircraft Stability. Chapter notes from Technical General for Aviators by Capt. Pankaj Pahil.",
        duration: "1 hr", questionCount: 6, content: makeContent(true),
      },
      {
        id: "tg-10", number: 10, title: "Aircraft Controls",
        description: "Principles of Flight — Aircraft Controls. Chapter notes from Technical General for Aviators by Capt. Pankaj Pahil.",
        duration: "1 hr", questionCount: 6, content: makeContent(true),
      },
      {
        id: "tg-11", number: 11, title: "Introduction to the Piston Engine and the Otto Cycle",
        description: "The Piston Engine — Introduction to the Piston Engine and the Otto Cycle. Chapter notes from Technical General for Aviators by Capt. Pankaj Pahil.",
        duration: "1 hr", questionCount: 5, content: makeContent(true),
      },
      {
        id: "tg-12", number: 12, title: "Engine Components and Construction",
        description: "The Piston Engine — Engine Components and Construction. Chapter notes from Technical General for Aviators by Capt. Pankaj Pahil.",
        duration: "1 hr", questionCount: 5, content: makeContent(true),
      },
      {
        id: "tg-13", number: 13, title: "Carburetion and Mixture Control",
        description: "The Piston Engine — Carburetion and Mixture Control. Chapter notes from Technical General for Aviators by Capt. Pankaj Pahil.",
        duration: "1 hr", questionCount: 5, content: makeContent(true),
      },
      {
        id: "tg-14", number: 14, title: "Aviation Gasoline (AVGAS) and Combustion",
        description: "The Piston Engine — Aviation Gasoline (AVGAS) and Combustion. Chapter notes from Technical General for Aviators by Capt. Pankaj Pahil.",
        duration: "1 hr", questionCount: 5, content: makeContent(true),
      },
      {
        id: "tg-15", number: 15, title: "Engine Cooling Systems",
        description: "The Piston Engine — Engine Cooling Systems. Chapter notes from Technical General for Aviators by Capt. Pankaj Pahil.",
        duration: "1 hr", questionCount: 5, content: makeContent(true),
      },
      {
        id: "tg-16", number: 16, title: "Engine Lubrication Systems",
        description: "The Piston Engine — Engine Lubrication Systems. Chapter notes from Technical General for Aviators by Capt. Pankaj Pahil.",
        duration: "1 hr", questionCount: 5, content: makeContent(true),
      },
      {
        id: "tg-17", number: 17, title: "Induction Icing and Ignition Systems",
        description: "The Piston Engine — Induction Icing and Ignition Systems. Chapter notes from Technical General for Aviators by Capt. Pankaj Pahil.",
        duration: "1 hr", questionCount: 6, content: makeContent(true),
      },
      {
        id: "tg-18", number: 18, title: "Supercharging and Turbocharging",
        description: "The Piston Engine — Supercharging and Turbocharging. Chapter notes from Technical General for Aviators by Capt. Pankaj Pahil.",
        duration: "1 hr", questionCount: 5, content: makeContent(true),
      },
      {
        id: "tg-19", number: 19, title: "Introduction to Gas Turbine Engines",
        description: "The Gas Turbine Engine — Introduction to Gas Turbine Engines. Chapter notes from Technical General for Aviators by Capt. Pankaj Pahil.",
        duration: "1 hr", questionCount: 5, content: makeContent(true),
      },
      {
        id: "tg-20", number: 20, title: "The Air Inlet",
        description: "The Gas Turbine Engine — The Air Inlet. Chapter notes from Technical General for Aviators by Capt. Pankaj Pahil.",
        duration: "1 hr", questionCount: 4, content: makeContent(true),
      },
      {
        id: "tg-21", number: 21, title: "Compressors",
        description: "The Gas Turbine Engine — Compressors. Chapter notes from Technical General for Aviators by Capt. Pankaj Pahil.",
        duration: "1 hr", questionCount: 5, content: makeContent(true),
      },
      {
        id: "tg-22", number: 22, title: "Combustion Chambers",
        description: "The Gas Turbine Engine — Combustion Chambers. Chapter notes from Technical General for Aviators by Capt. Pankaj Pahil.",
        duration: "1 hr", questionCount: 5, content: makeContent(true),
      },
      {
        id: "tg-23", number: 23, title: "The Turbine Assembly",
        description: "The Gas Turbine Engine — The Turbine Assembly. Chapter notes from Technical General for Aviators by Capt. Pankaj Pahil.",
        duration: "1 hr", questionCount: 5, content: makeContent(true),
      },
      {
        id: "tg-24", number: 24, title: "The Exhaust System and Thrust Reversal",
        description: "The Gas Turbine Engine — The Exhaust System and Thrust Reversal. Chapter notes from Technical General for Aviators by Capt. Pankaj Pahil.",
        duration: "1 hr", questionCount: 4, content: makeContent(true),
      },
      {
        id: "tg-25", number: 25, title: "Engine Starting and Auxiliary Power Units (APU)",
        description: "The Gas Turbine Engine — Engine Starting and Auxiliary Power Units (APU). Chapter notes from Technical General for Aviators by Capt. Pankaj Pahil.",
        duration: "1 hr", questionCount: 5, content: makeContent(true),
      },
      {
        id: "tg-26", number: 26, title: "Airframe Structures and Loads",
        description: "Aircraft Systems — Airframe Structures and Loads. Chapter notes from Technical General for Aviators by Capt. Pankaj Pahil.",
        duration: "1 hr", questionCount: 5, content: makeContent(true),
      },
      {
        id: "tg-27", number: 27, title: "Pneumatic Systems, Air Conditioning, and Pressurization",
        description: "Aircraft Systems — Pneumatic Systems, Air Conditioning, and Pressurization. Chapter notes from Technical General for Aviators by Capt. Pankaj Pahil.",
        duration: "1 hr", questionCount: 5, content: makeContent(true),
      },
      {
        id: "tg-28", number: 28, title: "Hydraulic Systems",
        description: "Aircraft Systems — Hydraulic Systems. Chapter notes from Technical General for Aviators by Capt. Pankaj Pahil.",
        duration: "1 hr", questionCount: 5, content: makeContent(true),
      },
      {
        id: "tg-29", number: 29, title: "Landing Gear Systems",
        description: "Aircraft Systems — Landing Gear Systems. Chapter notes from Technical General for Aviators by Capt. Pankaj Pahil.",
        duration: "1 hr", questionCount: 5, content: makeContent(true),
      },
      {
        id: "tg-30", number: 30, title: "Aircraft Wheels, Tyres, and Brakes",
        description: "Aircraft Systems — Aircraft Wheels, Tyres, and Brakes. Chapter notes from Technical General for Aviators by Capt. Pankaj Pahil.",
        duration: "1 hr", questionCount: 5, content: makeContent(true),
      },
      {
        id: "tg-31", number: 31, title: "Aircraft Fuel Systems",
        description: "Aircraft Systems — Aircraft Fuel Systems. Chapter notes from Technical General for Aviators by Capt. Pankaj Pahil.",
        duration: "1 hr", questionCount: 5, content: makeContent(true),
      },
      {
        id: "tg-32", number: 32, title: "Ice and Rain Protection",
        description: "Aircraft Systems — Ice and Rain Protection. Chapter notes from Technical General for Aviators by Capt. Pankaj Pahil.",
        duration: "1 hr", questionCount: 4, content: makeContent(true),
      },
      {
        id: "tg-33", number: 33, title: "Safety and Emergency Equipment",
        description: "Aircraft Systems — Safety and Emergency Equipment. Chapter notes from Technical General for Aviators by Capt. Pankaj Pahil.",
        duration: "1 hr", questionCount: 5, content: makeContent(true),
      },
      {
        id: "tg-34", number: 34, title: "Fundamentals of Electricity",
        description: "Electrical Systems — Fundamentals of Electricity. Chapter notes from Technical General for Aviators by Capt. Pankaj Pahil.",
        duration: "1 hr", questionCount: 6, content: makeContent(true),
      },
      {
        id: "tg-35", number: 35, title: "DC Generation and Distribution",
        description: "Electrical Systems — DC Generation and Distribution. Chapter notes from Technical General for Aviators by Capt. Pankaj Pahil.",
        duration: "1 hr", questionCount: 5, content: makeContent(true),
      },
      {
        id: "tg-36", number: 36, title: "AC Generation and Distribution",
        description: "Electrical Systems — AC Generation and Distribution. Chapter notes from Technical General for Aviators by Capt. Pankaj Pahil.",
        duration: "1 hr", questionCount: 5, content: makeContent(true),
      },
    ],
  },
  ...
  // ── PAPER 7 ── Radio Telephony ────────────────────────────────────────────
  {
    ...
    chapters: [
      // ── MODULE 0 · Orientation ──────────────────────────────────────────
      {
        ...
        duration: "2 hrs", questionCount: 15, content: notesOnly(),
      },
      // ── MODULE A · Rule-Makers & Regulations (Syllabus Part I) ───────────
      {
        ...
        duration: "2 hrs", questionCount: 8, content: notesOnly(),
      },
      {
        ...
        duration: "2 hrs", questionCount: 18, content: notesOnly(),
      },
      {
      ...
      },
      {
        ...
        duration: "3 hrs", questionCount: 18, content: notesOnly(),
      },
      {
      ...
      },
      {
        ...
        duration: "2 hrs", questionCount: 16, content: notesOnly(),
      },
      {
      ...
      },
      {
        ...
        duration: "3 hrs", questionCount: 20, content: notesOnly(),
      },
      ...
      },
      {
        ...
        duration: "1.5 hrs", questionCount: 12, content: notesOnly(),
      },
      {
      ...
      },
      {
        ...
        duration: "1.5 hrs", questionCount: 14, content: notesOnly(),
      },
      {
        ...
        duration: "1.5 hrs", questionCount: 8, content: notesOnly(),
      },
      {
        ...
        duration: "2 hrs", questionCount: 12, content: notesOnly(),
      },
      {
        ...
        duration: "4 hrs", questionCount: 418, content: notesOnly(),
      },
    ],
  },
  ...
  // ── INSTRUMENTATION (Oxford ATPL Book 5) ─────────────────────────────────
  {
    ...
    icon: "🧭",
    color: "#f59e0b",
    description: "Flight instruments, gyroscopics, compasses, air data, INS/IRS, FMS, EFIS, automatic flight control, warning & recording systems, and powerplant instrumentation. Chapter-wise study notes with diagrams, worked examples and practice Q&A.",
    examDuration: 60,
    totalQuestions: 50,
    passMark: 70,
    chapters: [
      {
        ...
        description: "Instrumentation Chapter 1: Characteristics and General Definitions. DGCA CPL/ATPL exam-ready study notes with diagrams, worked examples, and practice Q&A.",
        duration: "2 hrs", questionCount: 8, content: makeContent(true),
      },
      {
        id: "inst-2", number: 2, title: "Pitot and Static Sources",
        description: "Instrumentation Chapter 2: Pitot and Static Sources. DGCA CPL/ATPL exam-ready study notes with diagrams, worked examples, and practice Q&A.",
        duration: "2 hrs", questionCount: 8, content: makeContent(true),
      },
      {
        id: "inst-3", number: 3, title: "Air Temperature Measurement",
        description: "Instrumentation Chapter 3: Air Temperature Measurement. DGCA CPL/ATPL exam-ready study notes with diagrams, worked examples, and practice Q&A.",
        duration: "2 hrs", questionCount: 8, content: makeContent(true),
      },
      {
        id: "inst-4", number: 4, title: "The Airspeed Indicator (ASI)",
        description: "Instrumentation Chapter 4: The Airspeed Indicator (ASI). DGCA CPL/ATPL exam-ready study notes with diagrams, worked examples, and practice Q&A.",
        duration: "2 hrs", questionCount: 9, content: makeContent(true),
      },
      {
        id: "inst-5", number: 5, title: "The Pressure Altimeter",
        description: "Instrumentation Chapter 5: The Pressure Altimeter. DGCA CPL/ATPL exam-ready study notes with diagrams, worked examples, and practice Q&A.",
        duration: "2 hrs", questionCount: 7, content: makeContent(true),
      },
      {
        id: "inst-6", number: 6, title: "The Vertical Speed Indicator",
        description: "Instrumentation Chapter 6: The Vertical Speed Indicator. DGCA CPL/ATPL exam-ready study notes with diagrams, worked examples, and practice Q&A.",
        duration: "2 hrs", questionCount: 9, content: makeContent(true),
      },
      {
        id: "inst-7", number: 7, title: "The Machmeter",
        description: "Instrumentation Chapter 7: The Machmeter. DGCA CPL/ATPL exam-ready study notes with diagrams, worked examples, and practice Q&A.",
        duration: "2 hrs", questionCount: 9, content: makeContent(true),
      },
      {
        id: "inst-8", number: 8, title: "Air Data Computer",
        description: "Instrumentation Chapter 8: Air Data Computer. DGCA CPL/ATPL exam-ready study notes with diagrams, worked examples, and practice Q&A.",
        duration: "2 hrs", questionCount: 6, content: makeContent(true),
      },
      {
        id: "inst-9", number: 9, title: "Terrestrial Magnetism",
        description: "Instrumentation Chapter 9: Terrestrial Magnetism. DGCA CPL/ATPL exam-ready study notes with diagrams, worked examples, and practice Q&A.",
        duration: "2 hrs", questionCount: 7, content: makeContent(true),
      },
      {
        id: "inst-10", number: 10, title: "The Direct Indicating Compass",
        description: "Instrumentation Chapter 10: The Direct Indicating Compass. DGCA CPL/ATPL exam-ready study notes with diagrams, worked examples, and practice Q&A.",
        duration: "2 hrs", questionCount: 9, content: makeContent(true),
      },
      {
        id: "inst-11", number: 11, title: "Gyroscopes",
        description: "Instrumentation Chapter 11: Gyroscopes. DGCA CPL/ATPL exam-ready study notes with diagrams, worked examples, and practice Q&A.",
        duration: "2 hrs", questionCount: 9, content: makeContent(true),
      },
      {
        id: "inst-12", number: 12, title: "Directional Gyro Indicator (DGI)",
        description: "Instrumentation Chapter 12: Directional Gyro Indicator (DGI). DGCA CPL/ATPL exam-ready study notes with diagrams, worked examples, and practice Q&A.",
        duration: "2 hrs", questionCount: 10, content: makeContent(true),
      },
      {
        id: "inst-13", number: 13, title: "The Artificial Horizon",
        description: "Instrumentation Chapter 13: The Artificial Horizon. DGCA CPL/ATPL exam-ready study notes with diagrams, worked examples, and practice Q&A.",
        duration: "2 hrs", questionCount: 9, content: makeContent(true),
      },
      {
        id: "inst-14", number: 14, title: "The Turn and Slip Indicator",
        description: "Instrumentation Chapter 14: The Turn and Slip Indicator. DGCA CPL/ATPL exam-ready study notes with diagrams, worked examples, and practice Q&A.",
        duration: "2 hrs", questionCount: 6, content: makeContent(true),
      },
      {
        id: "inst-15", number: 15, title: "The Turn Co-ordinator",
        description: "Instrumentation Chapter 15: The Turn Co-ordinator. DGCA CPL/ATPL exam-ready study notes with diagrams, worked examples, and practice Q&A.",
        duration: "2 hrs", questionCount: 3, content: makeContent(true),
      },
      {
        id: "inst-16", number: 16, title: "Aircraft Magnetism",
        description: "Instrumentation Chapter 16: Aircraft Magnetism. DGCA CPL/ATPL exam-ready study notes with diagrams, worked examples, and practice Q&A.",
        duration: "2 hrs", questionCount: 7, content: makeContent(true),
      },
      {
        id: "inst-17", number: 17, title: "Remote Indicating Magnetic Compass",
        description: "Instrumentation Chapter 17: Remote Indicating Magnetic Compass. DGCA CPL/ATPL exam-ready study notes with diagrams, worked examples, and practice Q&A.",
        duration: "2 hrs", questionCount: 6, content: makeContent(true),
      },
      {
        id: "inst-18", number: 18, title: "Inertial Navigation Systems",
        description: "Instrumentation Chapter 18: Inertial Navigation Systems. DGCA CPL/ATPL exam-ready study notes with diagrams, worked examples, and practice Q&A.",
        duration: "2 hrs", questionCount: 8, content: makeContent(true),
      },
      {
        id: "inst-19", number: 19, title: "Inertial Reference System",
        description: "Instrumentation Chapter 19: Inertial Reference System. DGCA CPL/ATPL exam-ready study notes with diagrams, worked examples, and practice Q&A.",
        duration: "2 hrs", questionCount: 1, content: makeContent(true),
      },
      {
        id: "inst-20", number: 20, title: "Radio Altimeter",
        description: "Instrumentation Chapter 20: Radio Altimeter. DGCA CPL/ATPL exam-ready study notes with diagrams, worked examples, and practice Q&A.",
        duration: "2 hrs", questionCount: 0, content: makeContent(),
      },
      {
        id: "inst-21", number: 21, title: "Flight Management System",
        description: "Instrumentation Chapter 21: Flight Management System. DGCA CPL/ATPL exam-ready study notes with diagrams, worked examples, and practice Q&A.",
        duration: "2 hrs", questionCount: 0, content: makeContent(),
      },
      {
        id: "inst-22", number: 22, title: "Electronic Flight Information Systems",
        description: "Instrumentation Chapter 22: Electronic Flight Information Systems. DGCA CPL/ATPL exam-ready study notes with diagrams, worked examples, and practice Q&A.",
        duration: "2 hrs", questionCount: 16, content: makeContent(true),
      },
      {
        id: "inst-23", number: 23, title: "Basic Computers",
        description: "Instrumentation Chapter 23: Basic Computers. DGCA CPL/ATPL exam-ready study notes with diagrams, worked examples, and practice Q&A.",
        duration: "2 hrs", questionCount: 12, content: makeContent(true),
      },
      {
        id: "inst-24", number: 24, title: "Future Air Navigation Systems (FANS)",
        description: "Instrumentation Chapter 24: Future Air Navigation Systems (FANS). DGCA CPL/ATPL exam-ready study notes with diagrams, worked examples, and practice Q&A.",
        duration: "2 hrs", questionCount: 6, content: makeContent(true),
      },
      {
        id: "inst-25", number: 25, title: "Flight Director Systems",
        description: "Instrumentation Chapter 25: Flight Director Systems. DGCA CPL/ATPL exam-ready study notes with diagrams, worked examples, and practice Q&A.",
        duration: "2 hrs", questionCount: 6, content: makeContent(true),
      },
      {
        id: "inst-26", number: 26, title: "Autopilot",
        description: "Instrumentation Chapter 26: Autopilot. DGCA CPL/ATPL exam-ready study notes with diagrams, worked examples, and practice Q&A.",
        duration: "2 hrs", questionCount: 6, content: makeContent(true),
      },
      {
        id: "inst-27", number: 27, title: "Autoland",
        description: "Instrumentation Chapter 27: Autoland. DGCA CPL/ATPL exam-ready study notes with diagrams, worked examples, and practice Q&A.",
        duration: "2 hrs", questionCount: 6, content: makeContent(true),
      },
      {
        id: "inst-28", number: 28, title: "Autothrottle",
        description: "Instrumentation Chapter 28: Autothrottle. DGCA CPL/ATPL exam-ready study notes with diagrams, worked examples, and practice Q&A.",
        duration: "2 hrs", questionCount: 6, content: makeContent(true),
      },
      {
        id: "inst-29", number: 29, title: "Yaw Dampers",
        description: "Instrumentation Chapter 29: Yaw Dampers. DGCA CPL/ATPL exam-ready study notes with diagrams, worked examples, and practice Q&A.",
        duration: "2 hrs", questionCount: 6, content: makeContent(true),
      },
      {
        id: "inst-30", number: 30, title: "Control Laws",
        description: "Instrumentation Chapter 30: Control Laws. DGCA CPL/ATPL exam-ready study notes with diagrams, worked examples, and practice Q&A.",
        duration: "2 hrs", questionCount: 6, content: makeContent(true),
      },
      {
        id: "inst-31", number: 31, title: "AFCS Revision Questions",
        description: "Instrumentation Chapter 31: AFCS Revision Questions. DGCA CPL/ATPL exam-ready study notes with diagrams, worked examples, and practice Q&A.",
        duration: "2 hrs", questionCount: 0, content: makeContent(),
      },
      {
        id: "inst-32", number: 32, title: "Flight Warning Systems",
        description: "Instrumentation Chapter 32: Flight Warning Systems. DGCA CPL/ATPL exam-ready study notes with diagrams, worked examples, and practice Q&A.",
        duration: "2 hrs", questionCount: 6, content: makeContent(true),
      },
      {
        id: "inst-33", number: 33, title: "Aerodynamic Warnings",
        description: "Instrumentation Chapter 33: Aerodynamic Warnings. DGCA CPL/ATPL exam-ready study notes with diagrams, worked examples, and practice Q&A.",
        duration: "2 hrs", questionCount: 6, content: makeContent(true),
      },
      {
        id: "inst-34", number: 34, title: "Ground Proximity Warning System",
        description: "Instrumentation Chapter 34: Ground Proximity Warning System. DGCA CPL/ATPL exam-ready study notes with diagrams, worked examples, and practice Q&A.",
        duration: "2 hrs", questionCount: 6, content: makeContent(true),
      },
      {
        id: "inst-35", number: 35, title: "Airborne Collision and Avoidance System",
        description: "Instrumentation Chapter 35: Airborne Collision and Avoidance System. DGCA CPL/ATPL exam-ready study notes with diagrams, worked examples, and practice Q&A.",
        duration: "2 hrs", questionCount: 6, content: makeContent(true),
      },
      {
        id: "inst-36", number: 36, title: "Flight Data Recorder",
        description: "Instrumentation Chapter 36: Flight Data Recorder. DGCA CPL/ATPL exam-ready study notes with diagrams, worked examples, and practice Q&A.",
        duration: "2 hrs", questionCount: 6, content: makeContent(true),
      },
      {
        id: "inst-37", number: 37, title: "Cockpit Voice Recorder",
        description: "Instrumentation Chapter 37: Cockpit Voice Recorder. DGCA CPL/ATPL exam-ready study notes with diagrams, worked examples, and practice Q&A.",
        duration: "2 hrs", questionCount: 2, content: makeContent(true),
      },
      {
        id: "inst-38", number: 38, title: "Engine Instrumentation",
        description: "Instrumentation Chapter 38: Engine Instrumentation. DGCA CPL/ATPL exam-ready study notes with diagrams, worked examples, and practice Q&A.",
        duration: "2 hrs", questionCount: 6, content: makeContent(true),
      },
      {
        id: "inst-39", number: 39, title: "Electronic Instrumentation",
        description: "Instrumentation Chapter 39: Electronic Instrumentation. DGCA CPL/ATPL exam-ready study notes with diagrams, worked examples, and practice Q&A.",
        duration: "2 hrs", questionCount: 12, content: makeContent(true),
      },
      {
        id: "inst-40", number: 40, title: "Revision Questions",
        description: "Instrumentation Chapter 40: Revision Questions. DGCA CPL/ATPL exam-ready study notes with diagrams, worked examples, and practice Q&A.",
  ...
  },
  {
    ...
    icon: "📡",
    color: "#06b6d4",
    description: "Radio wave properties and propagation, modulation and antennae, and the full suite of radio navigation aids — Doppler, VDF, ADF/NDB, VOR, ILS, MLS, radar (ground/airborne/SSR), DME, RNAV, EFIS and GNSS. Chapter-wise study notes with practice Q&A.",
    examDuration: 60,
    totalQuestions: 50,
    passMark: 70,
    chapters: [
...
export const ATPL_SUBJECTS: Subject[] = [
  ...
  },
  {
    ...
    icon: "🧠",
    color: "#06b6d4",
    description: "The complete Human Performance & Limitations book by Capt. Pankaj Pahil — 26 chapters covering aviation physiology, the senses, illusions, fitness to fly, and aviation psychology, from the atmosphere and hypoxia through CRM, stress, fatigue and decision-making, with a full mock-exam question bank.",
    examDuration: 60,
    totalQuestions: 0,
    passMark: 75,
    chapters: [
      { id: "front-matter", number: 0, title: "Foreword & How to Use This Book",
        description: "The foreword, how to use this book, and the full table of contents.",
        duration: "20 min", questionCount: 0, content: makeContent() },
      // Module 0 — The Threshold
      { id: "hpl-1", number: 1, title: "The Human Factor",
        description: "What Human Performance & Limitations is and why it's examined, why the human element fails, the SHELL model of the pilot-system interface, the Dirty Dozen — twelve common precursors to error, and self-check memory aids.",
        duration: "1.5 hrs", questionCount: 0, content: makeContent() },
      // Module A — The Ocean of Air
      { id: "hpl-2", number: 2, title: "The Atmosphere",
        description: "The atmosphere's composition and layers, the gas laws (Boyle's, Dalton's, Henry's), and how pressure and temperature vary with altitude.",
        duration: "1.5 hrs", questionCount: 0, content: makeContent() },
      { id: "hpl-3", number: 3, title: "Altitude & Oxygen",
        description: "Partial pressure of oxygen and the effects of increasing altitude, the physiological zones of the atmosphere, and self-check memory aids.",
        duration: "1 hr", questionCount: 0, content: makeContent() },
      // Module B — The Living Machine
      { id: "hpl-4", number: 4, title: "The Brain & Nervous System",
        description: "The brain and the nervous system — structure and function relevant to pilot performance.",
        duration: "1 hr", questionCount: 0, content: makeContent() },
      { id: "hpl-5", number: 5, title: "Breath & Blood",
        description: "The respiratory system, the circulatory system, blood pressure, and the key numbers to know.",
        duration: "3 hrs", questionCount: 0, content: makeContent() },
      // Module C — The Thin Air
      { id: "hpl-6", number: 6, title: "Hypoxia",
        description: "Hypoxia — types, symptoms, stages, and time of useful consciousness.",
        duration: "1 hr", questionCount: 0, content: makeContent() },
      { id: "hpl-7", number: 7, title: "The Silent Killers",
        description: "Carbon monoxide poisoning and hyperventilation — symptoms, and how they mimic hypoxia.",
        duration: "1 hr", questionCount: 0, content: makeContent() },
      { id: "hpl-8", number: 8, title: "Pressure, TUC & Decompression",
        description: "The baroreceptor reflex, the 48-hour blood-donation rule, cabin pressurisation and time of useful consciousness, decompression theory, decompression sickness, and the 24-hour flying-after-diving rule.",
        duration: "2.5 hrs", questionCount: 0, content: makeContent() },
      // Module D — Poisons & The Cabin
      { id: "hpl-9", number: 9, title: "Smoking & Alcohol",
        description: "Smoking and alcohol — physiological effects and DGCA limits.",
        duration: "1 hr", questionCount: 0, content: makeContent() },
      { id: "hpl-10", number: 10, title: "The Cabin Environment",
        description: "Humidity, temperature, vibration, glare and UV radiation in the cabin, in-flight incapacitation, and fits and faints.",
        duration: "2 hrs", questionCount: 0, content: makeContent() },
      // Module E — The Senses
      { id: "hpl-11", number: 11, title: "The Eye",
        description: "The eye — structure and function, and the limitations of visual acuity.",
        duration: "1 hr", questionCount: 0, content: makeContent() },
      { id: "hpl-12", number: 12, title: "The Limits of Sight",
        description: "Limitations of the visual system, protection of vision, visual defects, colour vision and colour blindness, and vision versus reaction time.",
        duration: "2 hrs", questionCount: 0, content: makeContent() },
      { id: "hpl-13", number: 13, title: "The Ear & Balance",
        description: "The ear's two functions and three sections, the middle and inner ear, the Eustachian tube, the audible range of hearing, noise and hearing loss, hearing protection, and the balance mechanism.",
        duration: "1.5 hrs", questionCount: 0, content: makeContent() },
      // Module F — The Deceived Pilot
      { id: "hpl-14", number: 14, title: "Illusions & Spatial Disorientation",
        description: "Conflicts between the ears and the eyes, illusions and spatial disorientation/vertigo, illusions while taxiing, on take-off, false outside-reference triggers, illusions in the cruise, illusions on approach and landing, protective measures, and air/motion sickness.",
        duration: "3 hrs", questionCount: 0, content: makeContent() },
      { id: "hpl-15", number: 15, title: "The Forces",
        description: "Acceleration and G-forces, the effects of increased-G manoeuvres, the DGCA reference figure of 1.41G at 45°, factors affecting G-tolerance, and negative-G/red-out.",
        duration: "1.5 hrs", questionCount: 0, content: makeContent() },
      // Module G — The Fit Aviator
      { id: "hpl-16", number: 16, title: "Fitness & Nutrition",
        description: "Individual physical differences, exercise and weight, nutrition and food hygiene, hypoglycemia, and gastric distress from contaminated food.",
        duration: "1 hr", questionCount: 0, content: makeContent() },
      { id: "hpl-17", number: 17, title: "Fitness to Fly",
        description: "Sinus blockage, dental pain (barodontalgia), dehydration, personal hygiene, and common ailments affecting fitness to fly.",
        duration: "1 hr", questionCount: 0, content: makeContent() },
      { id: "hpl-18", number: 18, title: "Drugs & Self-Medication",
        description: "Drugs and self-medication, caffeine, anaesthetics and analgesics, hypothermia, toxic hazards, and dangerous cargo.",
        duration: "1.5 hrs", questionCount: 0, content: makeContent() },
      // Module H — The Mind Aloft
      { id: "hpl-19", number: 19, title: "Information Processing",
        description: "Introduction to aviation psychology, human error and human reliability, workload, and a functional model of information processing.",
        duration: "1 hr", questionCount: 0, content: makeContent() },
      { id: "hpl-20", number: 20, title: "Memory & Skill",
        description: "Types of memory and sensory memory, anticipation and perception, attention, vigilance and complacency, and motor programmes (the Anderson skill model).",
        duration: "1 hr", questionCount: 0, content: makeContent() },
      { id: "hpl-21", number: 21, title: "Workload, Error & Decisions",
        description: "Reflexes, reaction time, surprise and startle, quantitative overload and human reliability, short- and long-term memory, learning/retention/motivation, and experience, response, cognition and hallucination.",
        duration: "1.5 hrs", questionCount: 0, content: makeContent() },
      { id: "hpl-22", number: 22, title: "The Team & The Machine",
        description: "Judgment and decision-making, personality/attitude/situational awareness, the mechanics of decision-making, communication and teamwork, automation, human characteristics in cockpit design, and displays and controls.",
        duration: "2 hrs", questionCount: 0, content: makeContent() },
      // Module I — Rhythms & Resilience
      { id: "hpl-23", number: 23, title: "Stress, Arousal & Fatigue",
        description: "Stress tolerance, fatigue and arousal, and the well-being of operational personnel.",
        duration: "1 hr", questionCount: 0, content: makeContent() },
      { id: "hpl-24", number: 24, title: "Sleep & Body Clock",
        description: "Body-rhythm disturbance and the circadian cycle, sleep stages (NREM and REM), mental health problems and disorders, and master reference tables and mnemonics.",
        duration: "2.5 hrs", questionCount: 0, content: makeContent() },
      // Module J — The Exam Arsenal
      { id: "hpl-25", number: 25, title: "Numbers & Mnemonics",
        description: "Quick-reference numbers and mnemonics across the whole subject: atmosphere and altitude, hypoxia/TUC/decompression, poisons and the cabin, vision and hearing, forces and fitness, and psychology.",
        duration: "1 hr", questionCount: 0, content: makeContent() },
      { id: "hpl-26", number: 26, title: "Mock Papers + Viva Bank",
        description: "A 50-question mock exam covering the full syllabus, with worked answers and chapter cross-references.",
        duration: "2 hrs", questionCount: 0, content: makeContent() },
      { id: "back-matter", number: 27, title: "Glossary, Index & References",
        description: "A glossary of terms used throughout the book, an alphabetical index by chapter, references and further reading, and a word about the author.",
        duration: "20 min", questionCount: 0, content: makeContent() },
    ],
  },
  {
