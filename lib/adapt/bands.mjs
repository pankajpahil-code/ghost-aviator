...
// CORRECTED 2026-08-12. This table previously carried five bands of my own
// invention ("Well below the level" … "Well above the level"). A candidate
// reading his own real report aloud names SIX, and names them precisely:
//
//   "how excellent, good, reasonable, need attention, support, and need to
//    learn … green is for the best and red is that you have to be very
//    careful of it"
//
// (ADAPT_COMPETITIVE_AUDIT.md §7.2, transcript saved in tools/adapt/.)
//
// So the LABELS and their order are now the real ones, and the count is right.
// The sten BOUNDARIES between them are still ours — nobody has published those,
// and BAND_PROVENANCE says so. Splitting ten sten points across six bands puts
// two at each end and one each in the middle, which keeps the extremes as
// genuine extremes rather than letting a sten 6 read as "need attention".
export const COLOUR_BANDS = [
  ...
  },
  {
    ...
    colour: "#f59e0b",
    hex: "#f59e0b",
    advice: "Close to the middle and worth one focused week. This is the cheapest band on the report to move up.",
  },
  {
    key: "reasonable",
    sten: [6, 6],
    ...
    colour: "#eab308",
    hex: "#eab308",
    advice: "Where most candidates sit. Consistency is what separates this from the band above, not raw ability.",
  },
  {
    key: "good",
    sten: [7, 8],
...
export const BAND_PROVENANCE =
  "The 1-10 sten score and the six colour bands mirror the format the real screening reports in, and the band names are the ones a candidate read from his own report. Where the boundaries between them fall is our own judgement — the test publisher does not publish theirs.";
