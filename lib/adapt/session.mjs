...
//
// What is still OURS rather than the publisher's: the English module (their
// English test is a separate instrument that includes listening, which we do
// not yet do) and the attitudes questionnaire's length, which is deliberately
// short — see the note on its weight below.
//
...
export const MODULES = {
  ...
  "divided-attention": {
    ...
    blurb: "Monitor a gauge, work the radio and answer sums — all at once, for fifteen minutes, and it gets harder as it runs.",
