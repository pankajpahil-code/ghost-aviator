...
export default async function Image({
  ...
  const subjectName = subject ? `${subject.name} ATPL` : "DGCA ATPL Course";
    ...
    (
      <div
        style={{
          ...
          backgroundImage: "linear-gradient(to bottom right, #0a0f14, #1a1206)",
          padding: "80px",
        ...
        >
          <div
            style={{
              ...
              backgroundColor: "rgba(240, 145, 58, 0.15)",
              border: "1px solid rgba(240, 145, 58, 0.3)",
              color: "#f0913a",
              padding: "12px 24px",
              borderRadius: "100px",
              fontSize: "28px",
