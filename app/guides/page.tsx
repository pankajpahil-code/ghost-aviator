...
export default function GuidesIndexPage() {
  return (
    <div style={{ background: "#06040e" }} className="min-h-screen pb-20">
      {/* Header */}
      <div className="relative overflow-hidden" style={{ borderBottom: `1px solid #7c3aed25` }}>
        <div className="absolute inset-0 pointer-events-none"
             style={{ background: `radial-gradient(ellipse 80% 50% at 50% 0%, #7c3aed18 0%, transparent 65%)` }} />
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 relative z-10 text-center">
          <div className="inline-flex items-center justify-center p-3 rounded-full mb-6" style={{ background: "#7c3aed15", color: "#7c3aed" }}>
          ...
          {GUIDES.map(guide => (
            <Link key={guide.slug} href={`/guides/${guide.slug}`} className="block group no-underline">
              <div className="rounded-2xl p-6 transition-all duration-300"
                   style={{ background: "rgba(15,8,30,0.95)", border: `1px solid rgba(255,255,255,0.06)` }}>
