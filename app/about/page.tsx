        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-14">
          <div className="flex flex-col md:flex-row items-center gap-10">
            <div className="relative w-44 h-44 rounded-full overflow-hidden flex-shrink-0"
                 style={{ border: "2px solid rgba(180,100,255,0.4)", boxShadow: "0 0 40px rgba(150,0,255,0.25)" }}>
              <Image src="/ghost-mascot.png" alt="Capt. Pankaj Pahil — Ghost Aviator" fill
                     className="object-cover" style={{ objectPosition: "50% 14%", transform: "scale(1.6)" }} />
            </div>
